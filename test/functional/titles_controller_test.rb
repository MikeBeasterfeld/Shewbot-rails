...
class TitlesControllerTest < ActionController::TestCase
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post :create, title: { created_at: @title.created_at, ircuser_id: @title.ircuser_id, title: @title.title, title_lc: @title.title_lc }
    end
  ...
  test "should update title" do
    put :update, id: @title, title: { created_at: @title.created_at, ircuser_id: @title.ircuser_id, title: @title.title, title_lc: @title.title_lc }
    assert_redirected_to title_path(assigns(:title))
  end
