...
when 'development'
  ...
  title1 = show3.titles.create(title: "Title 1", irc_user_id: user1.id, art: '/assets/rails.png')
  title2 = show3.titles.create(title: "Title 2", irc_user_id: user2.id, art: '/assets/rails.png')
  title3 = show3.titles.create(title: "Title 3", irc_user_id: user3.id, art: '/assets/rails.png')
  title4 = show3.titles.create(title: "Title 4", irc_user_id: user4.id, art: '/assets/rails.png')
  title5 = show3.titles.create(title: "Title 5", irc_user_id: user1.id, art: '/assets/rails.png')
